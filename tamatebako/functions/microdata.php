...
add_filter( 'the_author_posts_link',          'tamatebako_microdata_the_author_posts_link',          5 );
add_filter( 'get_comment_author_link',        'tamatebako_microdata_get_comment_author_link',        5 );
add_filter( 'get_comment_author_url_link',    'tamatebako_microdata_get_comment_author_url_link',    5 );
add_filter( 'comment_reply_link',             'tamatebako_microdata_comment_reply_link_filter',      5 );
add_filter( 'get_avatar',                     'tamatebako_microdata_get_avatar',                     5 );
add_filter( 'post_thumbnail_html',            'tamatebako_microdata_post_thumbnail_html',            5 );
add_filter( 'comments_popup_link_attributes', 'tamatebako_microdata_comments_popup_link_attributes', 5 );
