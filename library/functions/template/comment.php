...
/**
 * Comments Error Message used in "comments.php"
 *
 * @since 0.1.0
 */
...
/**
 * Get Comments Error Used in "comments.php"
 *
 * @since 3.1.0
 *
 * @return string
 ...
 *
 * @param array $args Comment reply link args.
 * @return string
 */
function tamatebako_get_comment_reply_link( $args = array() ) {

	// If no threaded comment or is ping/trackback, bail.
 ...
 * @param array      $args    Comment callback args. Not used.
 * @param int        $depth   Comment depth. Not used.
 */
 ...
 *
 * @param array $args Comment parent link args.
 */
